...
// Spec-defined seed — color and position per the product spec. `key`
// looks up the localized name at each use site (`t("defaultStages."
// + key)`) rather than hardcoding English here, since these rows get
// written as plain data into `pipeline_stages.name`.
...
export default function PipelinesPage() {
  ...
  const seedDefaultPipeline = useCallback(async (): Promise<Pipeline | null> => {
    ...
    const stagesPayload = DEFAULT_STAGE_META.map((s) => ({
