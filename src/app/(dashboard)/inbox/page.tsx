...
function InboxPageInner() {
  ...
  const [whatsappChannelType, setWhatsappChannelType] = useState<
    "meta" | "wuzapi"
  >("meta");
  /**
  ...
  useEffect(() => {
    const checkConnection = async () => {
      ...
      // Drives which composer actions are shown — WuzAPI has no
      // Meta-style templates or interactive button/list messages.
      setWhatsappChannelType(
        data?.channel_type === "wuzapi" ? "wuzapi" : "meta",
      );
    };
