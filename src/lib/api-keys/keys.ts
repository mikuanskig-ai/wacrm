...
//
// Why the `zontalk_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a ZonTalk key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `zontalk_test_` variant if
...
export const API_KEY_PREFIX = 'zontalk_live_';
