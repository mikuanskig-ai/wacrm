...
// via `Authorization: Bearer zontalk_live_…`.
//
...
export async function requireApiKey(
  ...
  // Migration 062 — a suspended account's API keys stop working too,
  // same as the dashboard and the WhatsApp webhook.
  if (await isAccountSuspended(admin, row.account_id)) {
