...
interface MessageThreadProps {
  ...
  /**
   * The account's active WhatsApp channel. Meta-only composer actions
   * (templates, interactive button/list messages) are hidden when
   * this is 'wuzapi' — whatsmeow has no equivalent concept. Defaults
   * to 'meta' so existing callers that don't pass this keep showing
   * every action, matching pre-WuzAPI behaviour.
   */
  whatsappChannelType?: 'meta' | 'wuzapi';
}
