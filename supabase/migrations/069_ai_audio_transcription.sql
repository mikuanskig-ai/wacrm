-- ============================================================
-- 069_ai_audio_transcription.sql
-- (renumbered from 066 while porting onto main — 066/067/068 were
-- independently taken there by the same day's debounce/max-tool-
-- iterations/order-state work; content unchanged.)
--
